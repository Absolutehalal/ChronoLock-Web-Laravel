                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="inst-schedule.php">ERP Schedules</a></li>
                        </ol>
                    </nav>
        ...
        <div class="card card-default p-4">
          <button href="javascript:0" class="editClassSchedule media text-secondary " data-toggle="modal" data-target="#scheduleModal" value="{{$schedule->scheduleID}}">
            ...
            <div class="media-body">
              <h3 class="mt-0 mb-2 text-dark d-flex">{{ $schedule->instFirstName }} {{ $schedule->instLastName }}</h3>
              ...
              <div class="card text-center px-0 border-0">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <h4> <input type="text" class="input form-control" id="courseCode" name="courseCode"  readonly> <h4>
                  </div>
