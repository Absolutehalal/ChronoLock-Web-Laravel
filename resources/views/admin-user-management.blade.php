          ...
          <input type="hidden" id="user_ID" class="id form-control ">
            ...
            <div class="row">
              ...
              <ul id="editFirstNameError"></ul>
                <div class="form-group">
                  <label>First Name</label>
                  <input type="text" class="updateFirstName form-control border border-dark border border-dark" id="edit_firstName" name="updateFirstName"
              ...
              <ul id="editLastNameError"></ul>
                <div class="form-group">
                  <label>Last Name</label>
                  <input type="text" class="updateLastName form-control border border-dark border border-dark" id="edit_lastName" name="updateLastName"
              ...
              <ul id="editEmailError"></ul>
                <div class="form-group">
                  <label>Email</label>
                  <input type="text" class="updateEmail form-control border border-dark" id="edit_email" name="updateEmail"
                  placeholder="ex. chrono@my.cspc.edu.ph">
                  <!-- value="{{ $user->email }}" -->
                </div>
              </div>
              ...
              <ul id="editUserIdError"></ul>
                <div class="form-group">
                  ...
                  <input type="text" class="userIdNumber form-control border border-dark" id="edit_userId_no" name="userIdNumber"
