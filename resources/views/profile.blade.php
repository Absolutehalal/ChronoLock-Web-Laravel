          ...
          <div class="row mb-2">
            <div class="col-lg-6">
              <div class="form-group">
                <img src="{{ Auth::user()->avatar }}" class="user-image rounded-circle" style="display: block; margin-left: auto; margin-right: auto; height: 110px; width: 110px" alt="User Image" />
              </div>
            </div>
            <div class="col-lg-6">
...
<div class="modal fade" id="update-modal-profile" tabindex="-1" role="dialog" aria-labelledby="update-modal-profile" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body px-4">
        <form id="clearProfile" method="post">
          @csrf
          @method('put')
          ...
          <div class="row mb-2">
            <div class="col-lg-6">
              <div class="form-group">
                <img src="" id="edit-avatar" class="user-image rounded-circle" style="display: block; margin-left: auto; margin-right: auto; height: 110px; width: 110px" alt="User Image" />
              </div>
            </div>
            <div class="col-lg-6">
              <div class="form-group mt-3">
