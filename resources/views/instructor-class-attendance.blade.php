          ...
          <div class="d-flex justify-content-between align-items-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="inst-class-record.php">Class Attendance</a></li>
                        </ol>
                    </nav>
...
<div class="card card-default card-profile">
  ...
  <div class="card-footer card-profile-footer">
    <ul class="nav nav-border-top justify-content-center">
      <li class="nav-item">
        <a class="nav-link active" href="user-profile.html">Attendance</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{route('instructorClassList')}}">Class List</a>
      </li>
    </ul>
  </div>
</div>
