      ...
      <div class="content">
        ...
        <nav>
          <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
            <button class="nav-link active shadow" id="nav-admin-tab" data-bs-toggle="tab" data-bs-target="#nav-admin" type="button" role="tab" aria-controls="nav-admin" aria-selected="true">Admin</button>
            <button class="nav-link shadow" id="nav-labInCharge-tab" data-bs-toggle="tab" data-bs-target="#nav-labInCharge" type="button" role="tab" aria-controls="nav-labInCharge" aria-selected="false">Lab-in-Charge</button>
            <button class="nav-link shadow" id="nav-technician-tab" data-bs-toggle="tab" data-bs-target="#nav-technician" type="button" role="tab" aria-controls="nav-technician" aria-selected="false">Technician</button>
            <button class="nav-link shadow" id="nav-faculty-tab" data-bs-toggle="tab" data-bs-target="#nav-faculty" type="button" role="tab" aria-controls="nav-faculty" aria-selected="false">Faculty</button>
            <button class="nav-link shadow" id="nav-student-tab" data-bs-toggle="tab" data-bs-target="#nav-student" type="button" role="tab" aria-controls="nav-student" aria-selected="false">Students</button>
          </div>
        </nav>
