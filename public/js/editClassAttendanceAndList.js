        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status == 400) {
                    ...
                    $.each(
                        response.errors.updateStatus,
                        function (key, err_value) {
                            $("#editRemarkError").append(
                                "<li>" + err_value + "</li>"
                            );
                        }
                    );
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status == 400) {
                    ...
                    $.each(
                        response.errors.updateListUserID,
                        function (key, err_value) {
                            $("#editListIDError").append(
                                "<li>" + err_value + "</li>"
                            );
                        }
                    );
