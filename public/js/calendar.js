                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    if (response.status == 404) {
                                        ...
                                        startTime = strtTime.toLocaleTimeString(
                                            "en-US",
                                            {
                                                hour: "numeric",
                                                minute: "numeric",
                                ...
                                success: function (response) {
                                    ...
                                    if (response.status == 404) {
                                        ...
                                        var ndTime = new Date(
                                            "0000, 1, 1" +
                                                " " +
                                                response.makeUpSchedule.endTime
                                        );
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            if (response.status == 400) {
                                                ...
                                                $("#editProgramError").addClass(
                                                    "error"
                                                );
                                                $("#editYearError").html("");
                                                $("#editYearError").addClass(
                                                    "error"
                                                );
                                                $("#editSectionError").html("");
                                                $("#editSectionError").addClass(
                                                    "error"
                                                );
